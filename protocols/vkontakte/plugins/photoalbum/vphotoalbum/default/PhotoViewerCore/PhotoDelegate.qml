...
Package {
    ...
    Item {
        ...
        Item {
            ...
            Image {
				id: originalImage; smooth: true; source: src
            ...
            State {
				...
				PropertyChanges { target: photoWrapper; opacity: 1 /*stackItem.PathView.onPath ? 1.0 : 0.0 */}
            },
            State {
            ...
            State {
				...
				PropertyChanges { target: hqImage; source: listItem.ListView.isCurrentItem ? src_big : ""; visible: true }
            }
            ]
