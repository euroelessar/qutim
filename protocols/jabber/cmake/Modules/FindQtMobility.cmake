...
macro(export_component component)
    IF(NOT ${MOBILITY_CONFIG_MKSPECS_FILE} STREQUAL "")
		...
		if(${_COMPONENT} STREQUAL "multimediakit")
			set(_COMPONENT "multimedia") #simple hack
		endif()
        ...
        IF(${MOBILITY_FILE_CONTENTS} MATCHES "MOBILITY_CONFIG=.*${_COMPONENT}.*")
			...
			find_library(QT_MOBILITY_${_COMPONENT}_LIBRARY Qt${component} PATHS ${QT_MOBILITY_LIBRARY_DIR})
...
IF(NOT QT_MOBILITY_FOUND)
    if(QT_MOBILITY_TOO_OLD)
		MESSAGE(STATUS "The installed QtMobility version ${QT_MOBILITY_VERSION} it too old, version ${QtMobility_FIND_VERSION} is required.")
    ELSEIF(QT_MOBILITY_TOO_NEW)
		MESSAGE(STATUS "The installed QtMobility version ${QT_MOBILITY_VERSION} it too new, version ${QtMobility_FIND_VERSION} is required.")
    ELSE()
