...
public:
	JDataForm(const Jreen::DataForm::Ptr &form,
			  Ureen::AbstractDataForm::StandardButtons buttons = Ureen::AbstractDataForm::NoButton,
			  QWidget *parent = 0);
	...
	~JDataForm();
	Ureen::AbstractDataForm *widget();
	Jreen::DataForm::Ptr getDataForm();
	
	static Ureen::DataItem convertToDataItem(const Jreen::DataForm::Ptr &form, const QList<Jreen::BitsOfBinary::Ptr> &bobs = QList<Jreen::BitsOfBinary::Ptr>());
	static void convertFromDataItem(const Jreen::DataForm::Ptr &form, const Ureen::DataItem &item);
