...
#include <qutim/simplecontactlist/simplecontactlist.h>
...
void SymbianWidget::onAccountCreated(Ureen::Account *account)
{
...
void SymbianWidget::onAccountStatusChanged(const Ureen::Status &status)
{
