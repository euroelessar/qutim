...
namespace MeegoIntegration
{
	void Plugin::init()
	{
		Ureen::LocalizedString name = QT_TRANSLATE_NOOP("Plugin", "Meego application window");
		Ureen::LocalizedString description = QT_TRANSLATE_NOOP("Plugin", "Main window of application");
